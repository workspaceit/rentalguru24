              ...
              <form onsubmit="return addCMSPage();">
                <div class="box-body">
                  <div class="form-group">
                    ...
                    <input name="pageName" id="pageName" class="form-control" value="${cmsPages.getPageName()}">
                ...
                <div class="box-body">
                  <div class="form-group">
                    ...
                    <input name="pageKey" id="pageKey" class="form-control" value="${cmsPages.getPageKey()}">
                    <p class="help-block error-form" id="errorMsg_pageKey"></p>
                  </div>
                </div>
                <div class="box-body">
                  <label for="editor1" >Page Content</label>
                  <textarea id="editor1" name="editor1" rows="10" cols="80">${cmsPages.getPageContent()}</textarea>
                ...
                <input id="pageId" name="pageName" value="${cmsPages.getId()}" hidden>
              </form>
            </div>
          </div><!-- /.box -->
        </div><!-- /.col-->
...
<script>
  function addCMSPage(){
    ...
    $.ajax({
      url: BASEURL+'/api-admin/cms/edit-page/'+pageId,
      type: 'POST',
      data:{
        pageName :pageName,
        pageKey : pageKey,
